...
apt-get install -y xorg libjpeg62 fontconfig ttf-mscorefonts-installer xfonts-base xfonts-75dpi curl wget
apt-get install xvfb
curl -L -o crpdf "https://github.com/JorgenEvens/crPDF/releases/download/v0.2.0/crpdf-linux"
chmod +x crpdf
mv crpdf /usr/local/bin/crpdf
